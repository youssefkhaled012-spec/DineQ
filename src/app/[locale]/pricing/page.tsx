            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-32">
                {plans.map((plan, i) => (
                    <motion.div
                        ...
                        className={`flex flex-col p-8 rounded-3xl border relative transition-all duration-300 ${plan.popular
                                ? 'border-glow-purple bg-glow-purple/5 shadow-[0_0_40px_rgba(168,85,247,0.15)] scale-105 z-10'
                                : 'border-white/10 bg-white/5 hover:bg-white/10'
                            }`}
                    >
                        {plan.popular && (
                            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-glow-purple text-white text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider">
                        ...
                        <Button asChild className={`w-full h-12 rounded-xl font-bold text-base transition-all active:scale-95 ${plan.popular ? 'bg-white text-black hover:bg-white/90' : 'bg-white/10 text-white hover:bg-white/20'
                            }`}>
