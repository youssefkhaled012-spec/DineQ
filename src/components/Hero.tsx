        ...
        <section className="relative overflow-hidden pt-24 md:pt-32 pb-16 md:pb-24">
            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                <div className="flex flex-col items-center text-center">
                    ...
                    >
                        <Button asChild size="lg" className="h-12 px-8 bg-white text-black hover:bg-white/90 font-semibold shadow-[0_0_30px_rgba(255,255,255,0.1)] transition-all hover:shadow-[0_0_40px_rgba(255,255,255,0.2)] active:scale-[0.98]">
                            <Link href="/demo">
                                {t('cta_primary')} <ArrowRight className="ml-2 h-4 w-4 rtl:rotate-180" />
                            </Link>
                        </Button>
                        <Button asChild variant="outline" size="lg" className="h-12 px-8 border-white/10 hover:bg-white/5 backdrop-blur-sm transition-all active:scale-[0.98]">
                    ...
                    <motion.div
                        ...
                        className="inline-flex items-center rounded-full border border-white/10 bg-white/5 backdrop-blur-sm px-3 py-1 text-sm font-medium text-glow-purple shadow-[0_0_15px_rgba(168,85,247,0.1)]"
                    >
